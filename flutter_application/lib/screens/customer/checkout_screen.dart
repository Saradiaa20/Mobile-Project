...
//               initialValue: provider.governorate,
//               items: const [
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              onChanged: (value) {
                if (value != null) {
                  ref.read(checkoutProvider).governorate = value;
                  ref.read(checkoutProvider).notifyListeners();
                }
              },
              decoration: const InputDecoration(
                labelText: 'Governorate',
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  await ref.read(checkoutProvider).submitOrder(
                        total: cart.totalPrice,
                        items: cart.items,
                      );
